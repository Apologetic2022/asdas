...
var zhStrings = map[string]string{
	...
	// ── API Keys ──
	"keys_title":            "🔐 API 密钥",
	"keys_help":             " [s] 切换区块 • [↑↓/jk] 导航 • [a] 添加 • [e] 编辑 • [d] 删除 • [c] 复制 • [r] 刷新",
	"no_keys":               "  无 API Key，按 [a] 添加",
	"access_keys":           "Access API Keys",
	"cursor_keys":           "Cursor API Keys",
	"no_cursor_keys":        "  无 Cursor API Key，按 [s] 选中本区块后按 [a] 填写 crsr_... 密钥",
	...
	"new_cursor_key_prompt": "  Cursor API Key (crsr_...): ",
...
var enStrings = map[string]string{
	...
	// ── API Keys ──
	"keys_title":            "🔐 API Keys",
	"keys_help":             " [s] Switch section • [↑↓/jk] Navigate • [a] Add • [e] Edit • [d] Delete • [c] Copy • [r] Refresh",
	"no_keys":               "  No API Keys. Press [a] to add",
	"access_keys":           "Access API Keys",
	"cursor_keys":           "Cursor API Keys",
	"no_cursor_keys":        "  No Cursor API Keys. Press [s] to focus this section, then [a] to paste a crsr_... key",
