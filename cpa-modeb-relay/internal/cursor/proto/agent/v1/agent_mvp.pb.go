...
// Blob-addressed form of AgentConversationTurn: user_message and each step are
// KV blob ids holding the serialized message.
...
// Result shape carried by a completed tool call inside conversation history.
// Distinct from McpResult, which the exec channel uses for live submissions.
...
func (x *McpToolResult) GetError() *McpError {
	if x != nil {
...
func (x *McpToolCall) GetDescription() string {
...
func (*RequestedModel_ModelParameterValue) Descriptor() ([]byte, []int) {
	return file_agent_v1_agent_mvp_proto_rawDescGZIP(), []int{13, 0}
}
...
const file_agent_v1_agent_mvp_proto_rawDesc = "" +
	...
	"\asuccess\x18\x01 \x01(\v2\x14.agent.v1.McpSuccessH\x00R\asuccess\x12*\n" +
	"\x05error\x18\x02 \x01(\v2\x12.agent.v1.McpErrorH\x00R\x05error\x123\n" +
	"\brejected\x18\x03 \x01(\v2\x15.agent.v1.McpRejectedH\x00R\brejectedB\b\n" +
	"\x06result\"\x9c\x01\n" +
	"\vMcpToolCall\x12%\n" +
	"\x04args\x18\x01 \x01(\v2\x11.agent.v1.McpArgsR\x04args\x12/\n" +
	"\x06result\x18\x02 \x01(\v2\x17.agent.v1.McpToolResultR\x06result\x12%\n" +
	"\vdescription\x18\x03 \x01(\tH\x00R\vdescription\x88\x01\x01B\x0e\n" +
	"\f_description\"q\n" +
	"\bToolCall\x12;\n" +
	"\rmcp_tool_call\x18\x0f \x01(\v2\x15.agent.v1.McpToolCallH\x00R\vmcpToolCall\x12 \n" +
	...
	"\x19_git_status_info_complete\"Z\n" +
	...
	"\aexec_id\x18\x0f \x01(\tR\x06execId\x12P\n" +
	...
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x17\n" +
	"\aexec_id\x18\x0f \x01(\tR\x06execId\x12V\n" +
	...
	"\bmetric_4\x18\x04 \x01(\x01R\ametric4\"\xba\x03\n" +
	...
	"\x11kv_server_message\x18\x04 \x01(\v2\x19.agent.v1.KvServerMessageH\x00R\x0fkvServerMessage\x12E\n" +
...
var file_agent_v1_agent_mvp_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_agent_v1_agent_mvp_proto_goTypes = []any{
	...
	(*AssistantMessage)(nil),                   // 4: agent.v1.AssistantMessage
	(*ThinkingMessage)(nil),                    // 5: agent.v1.ThinkingMessage
	(*ConversationStep)(nil),                   // 6: agent.v1.ConversationStep
	(*AgentConversationTurnStructure)(nil),     // 7: agent.v1.AgentConversationTurnStructure
	(*ConversationTurnStructure)(nil),          // 8: agent.v1.ConversationTurnStructure
	(*ConversationStateStructure)(nil),         // 9: agent.v1.ConversationStateStructure
	(*ModelDetails)(nil),                       // 10: agent.v1.ModelDetails
	(*GetUsableModelsRequest)(nil),             // 11: agent.v1.GetUsableModelsRequest
	(*GetUsableModelsResponse)(nil),            // 12: agent.v1.GetUsableModelsResponse
	(*RequestedModel)(nil),                     // 13: agent.v1.RequestedModel
	(*McpToolDefinition)(nil),                  // 14: agent.v1.McpToolDefinition
	(*McpTools)(nil),                           // 15: agent.v1.McpTools
	(*AgentRunRequest)(nil),                    // 16: agent.v1.AgentRunRequest
	(*TextDeltaUpdate)(nil),                    // 17: agent.v1.TextDeltaUpdate
	(*ThinkingDeltaUpdate)(nil),                // 18: agent.v1.ThinkingDeltaUpdate
	(*TurnEndedUpdate)(nil),                    // 19: agent.v1.TurnEndedUpdate
	(*McpArgs)(nil),                            // 20: agent.v1.McpArgs
	(*McpTextContent)(nil),                     // 21: agent.v1.McpTextContent
	(*McpToolResultContentItem)(nil),           // 22: agent.v1.McpToolResultContentItem
	(*McpSuccess)(nil),                         // 23: agent.v1.McpSuccess
	(*McpError)(nil),                           // 24: agent.v1.McpError
	(*McpRejected)(nil),                        // 25: agent.v1.McpRejected
	(*McpToolNotFound)(nil),                    // 26: agent.v1.McpToolNotFound
	(*McpResult)(nil),                          // 27: agent.v1.McpResult
	(*McpToolResult)(nil),                      // 28: agent.v1.McpToolResult
	(*McpToolCall)(nil),                        // 29: agent.v1.McpToolCall
	(*ToolCall)(nil),                           // 30: agent.v1.ToolCall
	(*ToolCallStartedUpdate)(nil),              // 31: agent.v1.ToolCallStartedUpdate
	(*ToolCallCompletedUpdate)(nil),            // 32: agent.v1.ToolCallCompletedUpdate
	(*PartialToolCallUpdate)(nil),              // 33: agent.v1.PartialToolCallUpdate
	(*InteractionUpdate)(nil),                  // 34: agent.v1.InteractionUpdate
	(*ClientHeartbeat)(nil),                    // 35: agent.v1.ClientHeartbeat
	(*GetBlobArgs)(nil),                        // 36: agent.v1.GetBlobArgs
	(*GetBlobResult)(nil),                      // 37: agent.v1.GetBlobResult
	(*SetBlobArgs)(nil),                        // 38: agent.v1.SetBlobArgs
	(*SetBlobResult)(nil),                      // 39: agent.v1.SetBlobResult
	(*KvServerMessage)(nil),                    // 40: agent.v1.KvServerMessage
	(*KvClientMessage)(nil),                    // 41: agent.v1.KvClientMessage
	(*RequestContextArgs)(nil),                 // 42: agent.v1.RequestContextArgs
	(*RequestContext)(nil),                     // 43: agent.v1.RequestContext
	(*RequestContextSuccess)(nil),              // 44: agent.v1.RequestContextSuccess
	(*RequestContextResult)(nil),               // 45: agent.v1.RequestContextResult
	(*ExecServerMessage)(nil),                  // 46: agent.v1.ExecServerMessage
	(*ExecClientMessage)(nil),                  // 47: agent.v1.ExecClientMessage
	(*ExecClientStreamClose)(nil),              // 48: agent.v1.ExecClientStreamClose
	(*ExecClientThrow)(nil),                    // 49: agent.v1.ExecClientThrow
	(*ExecClientControlMessage)(nil),           // 50: agent.v1.ExecClientControlMessage
	(*AgentClientMessage)(nil),                 // 51: agent.v1.AgentClientMessage
	(*AgentServerMetrics)(nil),                 // 52: agent.v1.AgentServerMetrics
	(*AgentServerMessage)(nil),                 // 53: agent.v1.AgentServerMessage
	(*RequestedModel_ModelParameterValue)(nil), // 54: agent.v1.RequestedModel.ModelParameterValue
	nil,                    // 55: agent.v1.McpArgs.ArgsEntry
...
var file_agent_v1_agent_mvp_proto_depIdxs = []int32{
	...
	4,  // 3: agent.v1.ConversationStep.assistant_message:type_name -> agent.v1.AssistantMessage
	30, // 4: agent.v1.ConversationStep.tool_call:type_name -> agent.v1.ToolCall
	5,  // 5: agent.v1.ConversationStep.thinking_message:type_name -> agent.v1.ThinkingMessage
	7,  // 6: agent.v1.ConversationTurnStructure.agent_conversation_turn:type_name -> agent.v1.AgentConversationTurnStructure
	10, // 7: agent.v1.GetUsableModelsResponse.models:type_name -> agent.v1.ModelDetails
	54, // 8: agent.v1.RequestedModel.parameters:type_name -> agent.v1.RequestedModel.ModelParameterValue
	56, // 9: agent.v1.McpToolDefinition.input_schema:type_name -> google.protobuf.Value
	14, // 10: agent.v1.McpTools.mcp_tools:type_name -> agent.v1.McpToolDefinition
	9,  // 11: agent.v1.AgentRunRequest.conversation_state:type_name -> agent.v1.ConversationStateStructure
	3,  // 12: agent.v1.AgentRunRequest.action:type_name -> agent.v1.ConversationAction
	10, // 13: agent.v1.AgentRunRequest.model_details:type_name -> agent.v1.ModelDetails
	15, // 14: agent.v1.AgentRunRequest.mcp_tools:type_name -> agent.v1.McpTools
	13, // 15: agent.v1.AgentRunRequest.requested_model:type_name -> agent.v1.RequestedModel
	55, // 16: agent.v1.McpArgs.args:type_name -> agent.v1.McpArgs.ArgsEntry
	21, // 17: agent.v1.McpToolResultContentItem.text:type_name -> agent.v1.McpTextContent
	22, // 18: agent.v1.McpSuccess.content:type_name -> agent.v1.McpToolResultContentItem
	23, // 19: agent.v1.McpResult.success:type_name -> agent.v1.McpSuccess
	24, // 20: agent.v1.McpResult.error:type_name -> agent.v1.McpError
	25, // 21: agent.v1.McpResult.rejected:type_name -> agent.v1.McpRejected
	26, // 22: agent.v1.McpResult.tool_not_found:type_name -> agent.v1.McpToolNotFound
	23, // 23: agent.v1.McpToolResult.success:type_name -> agent.v1.McpSuccess
	24, // 24: agent.v1.McpToolResult.error:type_name -> agent.v1.McpError
	25, // 25: agent.v1.McpToolResult.rejected:type_name -> agent.v1.McpRejected
	20, // 26: agent.v1.McpToolCall.args:type_name -> agent.v1.McpArgs
	28, // 27: agent.v1.McpToolCall.result:type_name -> agent.v1.McpToolResult
	29, // 28: agent.v1.ToolCall.mcp_tool_call:type_name -> agent.v1.McpToolCall
	30, // 29: agent.v1.ToolCallStartedUpdate.tool_call:type_name -> agent.v1.ToolCall
	30, // 30: agent.v1.ToolCallCompletedUpdate.tool_call:type_name -> agent.v1.ToolCall
	30, // 31: agent.v1.PartialToolCallUpdate.tool_call:type_name -> agent.v1.ToolCall
	17, // 32: agent.v1.InteractionUpdate.text_delta:type_name -> agent.v1.TextDeltaUpdate
	31, // 33: agent.v1.InteractionUpdate.tool_call_started:type_name -> agent.v1.ToolCallStartedUpdate
	32, // 34: agent.v1.InteractionUpdate.tool_call_completed:type_name -> agent.v1.ToolCallCompletedUpdate
	18, // 35: agent.v1.InteractionUpdate.thinking_delta:type_name -> agent.v1.ThinkingDeltaUpdate
	33, // 36: agent.v1.InteractionUpdate.partial_tool_call:type_name -> agent.v1.PartialToolCallUpdate
	19, // 37: agent.v1.InteractionUpdate.turn_ended:type_name -> agent.v1.TurnEndedUpdate
	36, // 38: agent.v1.KvServerMessage.get_blob_args:type_name -> agent.v1.GetBlobArgs
	38, // 39: agent.v1.KvServerMessage.set_blob_args:type_name -> agent.v1.SetBlobArgs
	37, // 40: agent.v1.KvClientMessage.get_blob_result:type_name -> agent.v1.GetBlobResult
	39, // 41: agent.v1.KvClientMessage.set_blob_result:type_name -> agent.v1.SetBlobResult
	14, // 42: agent.v1.RequestContext.tools:type_name -> agent.v1.McpToolDefinition
	43, // 43: agent.v1.RequestContextSuccess.request_context:type_name -> agent.v1.RequestContext
	44, // 44: agent.v1.RequestContextResult.success:type_name -> agent.v1.RequestContextSuccess
	42, // 45: agent.v1.ExecServerMessage.request_context_args:type_name -> agent.v1.RequestContextArgs
	20, // 46: agent.v1.ExecServerMessage.mcp_args:type_name -> agent.v1.McpArgs
	45, // 47: agent.v1.ExecClientMessage.request_context_result:type_name -> agent.v1.RequestContextResult
	27, // 48: agent.v1.ExecClientMessage.mcp_result:type_name -> agent.v1.McpResult
	48, // 49: agent.v1.ExecClientControlMessage.stream_close:type_name -> agent.v1.ExecClientStreamClose
	49, // 50: agent.v1.ExecClientControlMessage.throw:type_name -> agent.v1.ExecClientThrow
	16, // 51: agent.v1.AgentClientMessage.run_request:type_name -> agent.v1.AgentRunRequest
	47, // 52: agent.v1.AgentClientMessage.exec_client_message:type_name -> agent.v1.ExecClientMessage
	41, // 53: agent.v1.AgentClientMessage.kv_client_message:type_name -> agent.v1.KvClientMessage
	50, // 54: agent.v1.AgentClientMessage.exec_client_control_message:type_name -> agent.v1.ExecClientControlMessage
	35, // 55: agent.v1.AgentClientMessage.client_heartbeat:type_name -> agent.v1.ClientHeartbeat
	34, // 56: agent.v1.AgentServerMessage.interaction_update:type_name -> agent.v1.InteractionUpdate
	46, // 57: agent.v1.AgentServerMessage.exec_server_message:type_name -> agent.v1.ExecServerMessage
	9,  // 58: agent.v1.AgentServerMessage.conversation_checkpoint_update:type_name -> agent.v1.ConversationStateStructure
	40, // 59: agent.v1.AgentServerMessage.kv_server_message:type_name -> agent.v1.KvServerMessage
	52, // 60: agent.v1.AgentServerMessage.server_metrics:type_name -> agent.v1.AgentServerMetrics
	56, // 61: agent.v1.McpArgs.ArgsEntry.value:type_name -> google.protobuf.Value
...
func file_agent_v1_agent_mvp_proto_init() {
	...
	file_agent_v1_agent_mvp_proto_msgTypes[6].OneofWrappers = []any{
		(*ConversationStep_AssistantMessage)(nil),
		(*ConversationStep_ToolCall)(nil),
		(*ConversationStep_ThinkingMessage)(nil),
	}
	file_agent_v1_agent_mvp_proto_msgTypes[7].OneofWrappers = []any{}
	file_agent_v1_agent_mvp_proto_msgTypes[8].OneofWrappers = []any{
		(*ConversationTurnStructure_AgentConversationTurn)(nil),
	}
	file_agent_v1_agent_mvp_proto_msgTypes[10].OneofWrappers = []any{}
	file_agent_v1_agent_mvp_proto_msgTypes[16].OneofWrappers = []any{}
	file_agent_v1_agent_mvp_proto_msgTypes[19].OneofWrappers = []any{}
	...
	file_agent_v1_agent_mvp_proto_msgTypes[28].OneofWrappers = []any{
	...
	file_agent_v1_agent_mvp_proto_msgTypes[30].OneofWrappers = []any{
		(*ToolCall_McpToolCall)(nil),
	}
	file_agent_v1_agent_mvp_proto_msgTypes[34].OneofWrappers = []any{
	...
	file_agent_v1_agent_mvp_proto_msgTypes[41].OneofWrappers = []any{
	...
	file_agent_v1_agent_mvp_proto_msgTypes[45].OneofWrappers = []any{
	...
	file_agent_v1_agent_mvp_proto_msgTypes[50].OneofWrappers = []any{
